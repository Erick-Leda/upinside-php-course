...
$address = new \Source\Related\Address("142", "19", "Quadra 266");
$company->boot(
    "UpInside",
    $address
);
...
echo "<p>{$company->getCompany()} tem sede na rua {$company->getAddress()->getStreet()}, de número {$company->getAddress()->getNumber()}, na {$company->getAddress()->getComplement()}</p>";
...
$company->addTeamMember("CEO", "Erick", "Leda");
$company->addTeamMember("Manager", "Luiz", "Passos");
