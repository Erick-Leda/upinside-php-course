...
fullStackPHPClassSession("__set", __LINE__);
 ...
 $fsphp = new \Source\Interpretation\Product("FSPHP", 1997, null);
...
fullStackPHPClassSession("__get", __LINE__);
 ...
 echo "<p>O curso {$fsphp->title} da {$fsphp->company} é o melhor curso de php 
 do mercado</p>";
...
fullStackPHPClassSession("__sleep", __LINE__);

var_dump($fsphp);
echo serialize($fsphp);
echo '<br/>';


fullStackPHPClassSession("__wakeup", __LINE__);

var_dump(serialize($fsphp));
var_dump(unserialize(serialize($fsphp)));
...
fullStackPHPClassSession("__debuginfo", __LINE__);

var_dump(new \Source\Interpretation\Product(null, 1997, null));

fullStackPHPClassSession("__set_state", __LINE__);

$fsphp = new \Source\Interpretation\Product('Erick', 1997, null);
$fsphp->name = "Cursos";
var_export($fsphp);
